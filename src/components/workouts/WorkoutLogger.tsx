import React, { useState, useEffect } from 'react';
    ...
    interface ExerciseLog {
      ...
      sets: Array<{
        ...
        reps: number;
        distance?: number;
        time?: string | number | null; // Updated to store time as 'HH:MM' or null
        calories?: number;
      }>;
    }
            ...
            try {
              ...
              const initialLogs =
                workout.workout_exercises?.map((exercise) => {
                  ...
                  const sets =
                    exerciseScores?.map((score) => ({
                      id: score.id,
                      weight: score.weight || 0,
                      reps: score.reps,
                      distance: score.distance,
                      time: formatTime(score.time), // Convert time to 'HH:MM'
                    ...
                    Array(exercise.sets).fill({
                      ...
                      time: formatTime(exercise.time), // Default to formatted 'HH:MM'
